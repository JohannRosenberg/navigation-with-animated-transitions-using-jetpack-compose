...
fun NavDrawer(
    ...
    val imageBitmap: ImageBitmap = ImageBitmap.imageResource(R.drawable.nav_drawer_bg)
    ...
    Surface(
        ...
        Column(
            modifier = modifier
                .fillMaxSize()
                .drawBehind {
                    this.drawImage(imageBitmap, dstSize = IntSize(1200, DeviceUtils.screenRectPx.height()))
                }
                .padding(20.dp)
